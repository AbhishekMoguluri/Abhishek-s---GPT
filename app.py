...
st.title("Abhishek's GPT - Resume Bot")
st.image("https://abhishekmoguluri.github.io/images/image-portfolio.jpg")
with st.expander("⚠️Disclaimer"):
    st.write("""This bot is a LLM trained on GPT-3.5-turbo model to answer questions about Abhishek's professional background and qualifications. Your responses are recorded in a database for quality assurance and improvement purposes. Please be respectful and avoid asking personal or inappropriate questions.""")
...
data_source = path+"/Abhishek-s---GPT/data/Aboutme.csv"
pdf_source = path+"/data/AM - Resume-.pdf"
...
def conversational_chat(query):
    ...
    if is_valid_json(result["answer"]):              
        ...
        data = json.loads('{"answered":"false", "response":"Hmm... Something is not right. I\'m experiencing technical difficulties. Try asking your question again or ask another question about Abhishek\'s professional background and qualifications. Thank you for your understanding.", "questions":["What is Hari\'s professional experience?","What projects has Hari worked on?","What are Abhishek\'s career goals?"]}')
    ...
    if ('I am tuned to only answer questions' in response) or (response == ""):
        full_response = """Unfortunately, I can't answer this question. My capabilities are limited to providing information about Abhishek's professional background and qualifications. If you have other inquiries, I recommend reaching out to Abhishek on [LinkedIn](https://www.linkedin.com/in/abhishekmoguluri/). I can answer questions like: \n - What is Abhishek's educational background? \n - Can you list Abhishek's professional experience? \n - What skills does Abhishek possess? \n"""
        store_conversation(st.session_state["uuid"], query, full_response, answered)
    else: 
        markdown_list = ""
        for item in questions:
            markdown_list += f"- {item}\n"
        full_response = response + "\n\n What else would you like to know about Abhishek? You can ask me: \n" + markdown_list
        store_conversation(st.session_state["uuid"], query, full_response, answered)
...
if "messages" not in st.session_state:
    ...
    with st.chat_message("assistant"):
        ...
        welcome_message = """
            Welcome! I'm **Resume Bot**, a virtual assistant designed to provide comprehensive insights into Abhishek's impressive background and qualifications. I have in-depth knowledge of his academic achievements, professional experiences, technical skills, and career aspirations. 

            Feel free to inquire about any aspect of Abhishek's profile, such as his educational journey, internships, professional projects, areas of expertise in data science and AI, or his future goals. I can elaborate on topics like:
                ...
                - His proven track record in roles at Amazon
            ...
            I'm here to provide you with a comprehensive understanding of Abhishek's unique qualifications and capabilities. What would you like to know first? I'm ready to answer your questions in detail.
            """
...
if prompt := st.chat_input("Ask me about Abhishek"):
